...
const ParamsEntries = new URLSearchParams(searchParams).entries();
const ParamsArray = Array.from(ParamsEntries);
const BlogId = ParamsArray[0][1];
console.log(BlogId);

const Blog = data.BlogContent.find((element) => element.id == BlogId);
console.log(Blog);
...
var ourGeneratedHTML = compiledTemplate(Blog, {
  noEscape: true,
});
